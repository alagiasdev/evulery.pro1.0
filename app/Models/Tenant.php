...
class Tenant
{
    ...
    public function update(int $id, array $data): bool
    {
        ...
        $allowed = [
            ...
            'timezone', 'menu_enabled', 'promo_widget_only', 'pet_friendly', 'kids_friendly',
            ...
            'menu_hero_image', 'menu_tagline', 'menu_featured_label', 'menu_languages',
            'opening_hours', 'is_active', 'is_demo', 'max_staff', 'cancellation_cutoff_hours',
