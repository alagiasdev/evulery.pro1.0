...
<?php $activeKey = 'settings-ordering'; include __DIR__ . '/../../partials/settings-tabs.php'; ?>
    ...
    <div class="col-lg-7">
        <form method="POST" action="<?= url('dashboard/settings/ordering') ?>">
                ...
                <div class="form-body">
                    ...
                    <div class="row g-3 mt-1">
                        <div class="col-md-4">
                            ...
                            <div style="font-size:.68rem;color:var(--mute);margin-top:.25rem;">Quanto tempo serve per preparare un ordine. Il primo slot disponibile sarà a partire da questi minuti rispetto ad adesso.</div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div style="font-size:.68rem;color:var(--mute);margin-top:.25rem;">Ogni quanti minuti viene generato uno slot. Es. 15 → 12:00, 12:15, 12:30…</div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div style="font-size:.68rem;color:var(--mute);margin-top:.25rem;">Quanti ordini al massimo concentri nello stesso slot. Raggiunto il limite, lo slot sparisce dal widget.</div>
                        </div>
                    </div>
                    <div class="mt-3">
                        ...
                        <div style="font-size:.68rem; color:var(--faint); margin-top:.15rem;">Se attivo, gli ordini vengono confermati senza intervento manuale</div>
                    </div>
                </div>
            </div>
            ...
            <div class="card section-card mb-3">
                ...
                <div class="form-body">
                    ...
                    <div class="row g-2 align-items-center mb-2">
                        ...
                        <div class="col-1 text-center" style="font-size:.75rem; color:var(--faint);">&ndash;</div>
                        <div class="col-4 col-md-3">
                    ...
                    <?php endforeach; ?>
                    <div style="font-size:.68rem; color:var(--faint); margin-top:.5rem;">
            ...
            <div class="card section-card mb-3">
                ...
                <div class="form-body">
                    ...
                    <div style="font-size:.68rem; color:var(--faint); margin-top:.5rem;">Per pagamenti online, configura Stripe nella sezione <a href="<?= url('dashboard/settings/deposit') ?>" style="color:var(--brand, #00844A);">Caparra</a>.</div>
                    <?php endif; ?>
                </div>
            </div>
                ...
                <div class="form-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4" id="simpleDeliveryFee">
                            ...
                            <div style="font-size:.65rem; color:var(--faint);">Usato se tariffa fissa</div>
                        </div>
                    ...
                    <div class="mt-3" id="simpleDeliveryDesc">
                        ...
                        <div style="font-size:.65rem; color:var(--faint);">Visibile ai clienti nello store</div>
                    </div>
                </div>
            </div>
            ...
            <div class="card section-card mb-3" id="deliveryBoardSettings" style="<?= $showDelivery ? '' : 'display:none' ?>">
                ...
                <div class="form-body">
                    ...
                    <div style="background:var(--surface-softer); border-radius:10px; padding:.75rem; margin-bottom:.75rem;">
                        <div style="font-size:.7rem; font-weight:600; color:var(--mute); margin-bottom:.25rem;"><i class="bi bi-link-45deg me-1"></i> Link board</div>
                    ...
                    <div style="font-size:.65rem; color:var(--faint); margin-top:.5rem;">
                    ...
                    <div class="mt-2">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="regenerate_token" style="font-size:.75rem; color:var(--mute);">Rigenera token (il link cambier&agrave;)</label>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card section-card mt-4">
            ...
            <div class="form-body">
                ...
                <div class="d-flex align-items-center gap-2 py-2" style="border-bottom:1px solid var(--hairline);">
                    <div style="min-width:90px;">
                        <div style="font-weight:600; font-size:.82rem;"><?= e($zone['name']) ?></div>
                    </div>
                    <div style="flex:1; font-size:.72rem; color:var(--mute);"><?= e(implode(', ', $zone['postal_codes'])) ?></div>
                    <div style="font-size:.82rem; font-weight:600; white-space:nowrap;">&euro; <?= number_format((float)$zone['fee'], 2, ',', '.') ?></div>
                    <div style="font-size:.72rem; color:var(--mute); white-space:nowrap;">min &euro;<?= number_format((float)$zone['min_amount'], 2, ',', '.') ?></div>
                ...
                <?php endforeach; ?>
                <?php else: ?>
                <p style="font-size:.78rem; color:var(--faint); margin-bottom:.75rem;">Nessuna zona configurata. Aggiungi la prima zona di consegna.</p>
                <?php endif; ?>

                <!-- Add zone form -->
                <div style="background:var(--surface-softer); border-radius:10px; padding:1rem; margin-top:.75rem;">
                    ...
                    <form method="POST" action="<?= url('dashboard/settings/ordering/zones') ?>">
                        ...
                        <div class="row g-2 align-items-end">
                            <div class="col-md-3">
                                <label style="font-size:.7rem; font-weight:600; color:var(--body); display:block; margin-bottom:.2rem;">Nome</label>
                                <input type="text" class="form-control form-control-sm" name="name" placeholder="Es: Centro" required>
                            </div>
                            <div class="col-md-3">
                                <label style="font-size:.7rem; font-weight:600; color:var(--body); display:block; margin-bottom:.2rem;">CAP</label>
                                <input type="text" class="form-control form-control-sm" name="postal_codes" placeholder="00186, 00187..." required>
                            </div>
                            <div class="col-md-2">
                                <label style="font-size:.7rem; font-weight:600; color:var(--body); display:block; margin-bottom:.2rem;">Costo (&euro;)</label>
                                <input type="number" class="form-control form-control-sm" name="fee" step="0.50" min="0" placeholder="3.00">
                            </div>
                            <div class="col-md-2">
                                <label style="font-size:.7rem; font-weight:600; color:var(--body); display:block; margin-bottom:.2rem;">Min (&euro;)</label>
        ...
        <div class="card section-card" style="position:sticky; top:1rem;">
            <div class="card-body">
                ...
                <div class="d-flex gap-2 mb-2">
                    ...
                    <div style="font-size:.75rem; color:var(--body);"><strong>Abilita</strong> gli ordini online e scegli il tipo di servizio</div>
                </div>
                <div class="d-flex gap-2 mb-2">
                    ...
                    <div style="font-size:.75rem; color:var(--body);">Nel <strong>Menu</strong>, abilita "Ordinabile online" sui piatti che vuoi vendere</div>
                </div>
                <div class="d-flex gap-2 mb-2">
                    ...
                    <div style="font-size:.75rem; color:var(--body);">I clienti ordinano da <strong>/<?= e($tenant['slug']) ?>/order</strong> e tu gestisci dalla sezione <strong>Ordini</strong></div>
                </div>
                <div class="d-flex gap-2 mb-3">
                    ...
                    <div style="font-size:.75rem; color:var(--body);">Accetta/rifiuta, segui la <strong>preparazione</strong> e segna come completato</div>
                </div>
                <hr>
