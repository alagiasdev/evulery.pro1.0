...
<div
    ...
    data-heartbeat-label="sulle prenotazioni di questa pagina"
        ...
        <div class="res-row <?= $r['status'] === 'pending' ? 'is-pending' : '' ?>"
            ...
            <div class="res-info">
                ...
                <div class="res-contact">
                    <a href="tel:<?= e(preg_replace('/[^0-9+]/', '', (string)$r['phone'])) ?>" class="res-call" aria-label="Chiama"><i class="bi bi-telephone"></i></a><span class="res-phone-num"><?= e($r['phone']) ?></span>
...
(function() {
    ...
    document.addEventListener('click', function(e) {
        if (!isMobile && !e.target.closest('#res-cal-dropdown') && !e.target.closest('#res-cal-toggle')) {
            closeCal();
        }
    });
})();
