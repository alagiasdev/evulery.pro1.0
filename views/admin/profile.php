        ...
        <form method="POST" action="<?= url('admin/profile') ?>">
            ...
            <div class="adm-card" style="margin-bottom:1.5rem;">
                <div style="padding:1rem 1.25rem;border-bottom:1px solid #eee;">
                    ...
                    <div style="font-size:.78rem;color:var(--mute);">Nome e contatti</div>
                </div>
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1rem;">
                        <div>
                            ...
                            <input type="text" name="first_name" value="<?= e($user['first_name'] ?? '') ?>" required
                                   style="width:100%;padding:.5rem .75rem;border:1px solid var(--hairline-strong);border-radius:8px;font-size:.85rem;">
                        </div>
                        <div>
            ...
            <div class="adm-card" style="margin-bottom:1.5rem;">
                <div style="padding:1rem 1.25rem;border-bottom:1px solid #eee;">
                    ...
                    <div style="font-size:.78rem;color:var(--mute);">Lascia vuoto per mantenere la password attuale</div>
                </div>
                <div style="padding:1.25rem;">
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;">
                        <div>
                            ...
                            <input type="password" name="new_password" autocomplete="new-password"
                                   style="width:100%;padding:.5rem .75rem;border:1px solid var(--hairline-strong);border-radius:8px;font-size:.85rem;">
                            <div style="font-size:.72rem;color:var(--mute);margin-top:.35rem;">Min. 8 caratteri, una maiuscola e un numero</div>
                        </div>
                        <div>
    ...
    <div>
        <div class="adm-card">
            <div style="padding:1.25rem;">
                ...
                <div style="font-size:.82rem;color:var(--body);line-height:1.8;">
