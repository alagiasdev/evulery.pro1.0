...
<head>
    ...
    <title><?= e($tenantName ?? 'Ristorante') ?> - Menu non disponibile</title>
    ...
    <style nonce="<?= csp_nonce() ?>">
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .pub-susp-cta{display:inline-block;margin-top:1.5rem;padding:.6rem 1.5rem;background:#1565C0;color:#fff;border-radius:10px;text-decoration:none;font-size:.88rem;font-weight:600;transition:background .15s}
        .pub-susp-cta:hover{background:#0d47a1;color:#fff}
...
<body>
    <div class="pub-susp">
        ...
        <div class="pub-susp-card">
            <div class="pub-susp-icon"><i class="bi bi-book"></i></div>
            <div class="pub-susp-title">Menu non disponibile</div>
            <p class="pub-susp-text">
                Il menu digitale non è al momento attivo.<br>
                Per consultare il menu, contatta direttamente il ristorante.
            </p>
            ...
            <a href="<?= e($bookingUrl) ?>" class="pub-susp-cta">
                <i class="bi bi-calendar-check me-1"></i> Prenota un tavolo
            </a>
            <?php endif; ?>
        </div>
